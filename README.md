...
In this repository you can find some tools that will allow you to generate and validate the format (structure) of a integration definition file.

Validation is automatically executed whenever there is a contribution via pull request.
...
New Relic integration definitions is licensed under the [Apache 2.0](http://apache.org/licenses/LICENSE-2.0.txt) License.
